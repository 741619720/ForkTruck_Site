...
urlpatterns = [
    ...
    path('login/article-edit.html', views.EditTask),
    path('login/delete', views.DeleteTask),
    url(r'^login/edit/(?P<taskID>.+)$', views.EditTask, name='edit'),
    url(r'^login/delete/(?P<taskID>.+)$', views.DeleteTask, name='delete'),
